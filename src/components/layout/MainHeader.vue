        ...
        <nav class="navbar navbar-expand-xl">
            <div class="container">
                ...
                >
                    ...
                    ><span class="d-none d-sm-inline-block small"
                        >Category</span
                    >
                </button>
                                    ...
                                    >
                                        ...
                                        <li>
                                            <a
                                                ...
                                                >Hero Image Gallery</a
                                            >
                                        </li>
                                        <li>
                                            <a
                                                class="dropdown-item"
                                                href="hero-split.html"
                                                >Hero Split</a
                                            >
                                        </li>
                                    </ul>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            >
                                ...
                                <li>
                                    ...
                                    >
                                        <i
                                            class="text-danger fa-fw bi bi-card-text me-2"
                                        ></i
                                        >Documentation
                                    </a>
                                </li>
                                ...
                                <li>
                                    ...
                                    >
                                        <i
                                            class="text-info fa-fw bi bi-toggle-off me-2"
                                        ></i
                                        >RTL demo
                                    </a>
                                </li>
                                ...
                                <li>
                                    ...
                                    >
                                        <i
                                            class="text-orange fa-fw bi bi-puzzle-fill me-2"
                                        ></i
                                        >Components
                                    </a>
                                </li>
                    ...
                    >
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="index.html"
                                ><i class="fa-solid fa-hotel me-2"></i>Hotel</a
                            >
                        </li>

                        <!-- Nav item Flight -->
                        <li class="nav-item">
                            <a class="nav-link" href="index-flight.html"
                                ><i class="fa-solid fa-plane me-2"></i>Flight</a
                            >
                        </li>

                        <!-- Nav item Tour -->
                        <li class="nav-item">
                            <a class="nav-link" href="index-tour.html"
                        ...
                        <!-- Nav item Cabs -->
                        <li class="nav-item">
                            <a class="nav-link" href="index-cab.html"
                                ><i class="fa-solid fa-car me-2"></i>Cab</a
                            >
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="card-body p-0">
                                    ...
                                    >
                                        ...
                                        <li>
                                            ...
                                            >
                                                <h6 class="mb-2">
                                                    New! Booking flights from
                                                    New York ✈️
                                                </h6>
                                                <p class="mb-0 small">
                                                    Find the flexible ticket on
                        ...
                        >
                            ...
                            <li>
                                <a class="dropdown-item" href="#"
                                    ><i
                                        class="bi bi-bookmark-check fa-fw me-2"
                                    ></i
                                    >My Bookings</a
                                >
                            </li>
                            <li>
                                <a class="dropdown-item" href="#"
                                    ><i class="bi bi-heart fa-fw me-2"></i>My
                                    Wishlist</a
                                >
                            </li>
                            <li>
